package huttar.net.wondrousworks;
...
import huttar.net.wondrousworks.dummy.Categories;
import huttar.net.wondrousworks.dummy.Category;
...
public class WorkListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(Categories.ITEMS));
    }
